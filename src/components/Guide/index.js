...
<div className="card m-2 col-md"   >
  ...
  <label for="cardrepGuide3">Nombre de répétions:</label>
...
<div className="card m-2 col-md"  >
  ...
  <div className="card-body input_bloc_center">
	...
	<label for="cardserGuide8">Nombre de séries:</label>
